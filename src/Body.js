...
<div className="welcome-div container">
        ...
        <div className="news container">
          <h2>News</h2>
                ...
                <a href='/News' type="button" className="btn btn-outline-primary" style={{width:'150px'}}>View All</a>
        ...
        <div className="events container">
          ...
          <div className="container" >
            <a href="/Events"><button className="btn btn-outline-primary" style={{marginLeft:'90px'}}>View All</button></a>
          </div>
        </div>
