            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              <ul className="navbar-nav ml-auto">
                <li className="nav-item dropdown">
                  <a className="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"data-bs-toggle="dropdown"aria-expanded="false">Programmes</a>
                ...
                <li className="nav-item"><a className="nav-link" href="#"> Admissions</a>
                </li>
                ...
                <li className="nav-item"><a className="nav-link" href="#">Galle</a>
                </li>
              </ul>
            </div>
          </div>
